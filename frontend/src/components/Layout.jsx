...
export default function Layout({ page, setPage, children }) {
  return <div className="app-shell">
    <header className="navbar">
      <div className="brand"><Activity size={24}/><div><strong>Estado actual de los municipios - Sismo</strong><span>Evento del 10 de agosto de 2026 - Actualización 24/08/2026</span></div></div>
      <nav>
